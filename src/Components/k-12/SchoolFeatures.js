...
import SchoolAnimation from "../../images/SchoolAnimation.png"
import School3D from "../../images/School3D.png"




class SchoolFeatures extends React.Component {
    render() {
                ...
                <Container style={{
                    ...
                    <Row>
                        ...
                        <Col xl={2} style={{
                            ...
                            <Image className="px-4 py-4" src={School3D} fluid height="auto" width="auto" style={{
                                // border: "2px solid red",
                            }} />
                            <p className="py-2 text-center" style={{
                                fontFamily: "'Nunito', sans-serif",
                                fontWeight: "800",
                            }}>3D Coding<br></br>(AR, VR)</p>
                        ...
                        <Col xl={2} style={{
                            ...
                            <Image className="px-4 py-4" src={SchoolAnimation} fluid height="auto" width="auto" style={{
                                // border: "2px solid red",
                            }} />
                            <p className="py-2 text-center" style={{
                                fontFamily: "'Nunito', sans-serif",
                                fontWeight: "800",
                            }}>Animation<br></br> Creation</p>
