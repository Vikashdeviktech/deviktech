...
class SchoolTab extends React.Component {
    render() {
                                ...
                                <Tab.Content className="text-left">
                                        ...
                                        <Row >
                                            <Col xs={12} xl={4}>
                                                <Card className="my-2" style={{ width: 'auto', border: "2px solid #0F2B48" }}>
                                                    <Image className="px-4 py-4" src={ScratchLogo} fluid height="auto" width="auto" style={{
                                                        // border: "2px solid red",
                                                    }} />
                                                    <Card.Body>
                                                        <Card.Title style={{
                                                            ...
                                                            fontWeight: "800",
                                                            fontSize: "20px",
                                                        }}>Animation and Story Telling with Code</Card.Title>
                                            ...
                                            <Col xs={12} xl={4}>
                                                <Card className="my-2" style={{ width: 'auto', border: "2px solid #0F2B48" }}>
                                                    <Image className="px-4 py-4" src={MitLogo} fluid height="auto" width="auto" style={{
                                                        // border: "2px solid red",
                                                    }} />
                                                    <Card.Body>
                                                        <Card.Title style={{
                                                    ...
                                                    <ButtonStyle1 className="text-center" href="https://drive.google.com/uc?export=download&id=1wI_ZOrvaMwPY5matclktxL3nh-esJwka">
                                                        <FontAwesomeIcon icon={faDownload} color="#0F2B48" size="1x" /> Download Curriculum
                                                    </ButtonStyle1>
                                                    <ButtonStyle>
                                                        Book A Demo
                                    ...
                                    <Tab.Pane eventKey="third" >
                                        <Row >
                                            <Col xs={12} xl={4}>
                                                <Card className="my-2" style={{ width: 'auto', border: "2px solid #0F2B48" }}>
                                                    <Image className="px-4 py-4" src={WebDesign} fluid height="auto" width="auto" style={{
                                                        // border: "2px solid red",
                                                    }} />
                                                    <Card.Body>
                                                        <Card.Title style={{
                                                ...
                                                <Card className="my-2" style={{ width: 'auto', border: "2px solid #0F2B48" }}>
                                                    ...
                                                    <Card.Body>
                                                        <Card.Title style={{
                                                            ...
                                                            fontWeight: "800",
                                                            fontSize: "20px",
                                                        }}>FullStack Web Development</Card.Title>
                                                        <Row className="my-2" style={{
                                                            // border: "2px solid red",
                                                            fontFamily: "'Nunito', sans-serif",
                                                            fontWeight: "800",
                                            ...
                                            <Col xs={12} xl={4}>
                                                <Card className="my-2" style={{ width: 'auto', border: "2px solid #0F2B48" }}>
                                                    <Image className="px-4 py-4" src={EthicalHacking} fluid height="auto" width="auto" style={{
                                                        // border: "2px solid red",
                                                    }} />
                                                    <Card.Body>
                                                        <Card.Title style={{
